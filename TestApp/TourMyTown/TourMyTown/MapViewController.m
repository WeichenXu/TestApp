...
@property (atomic, assign) CLLocationCoordinate2D currentLocation;
...
- (IBAction)addLocation:(id)sender {
    ...
    CLLocationCoordinate2D centerCoord = self.currentLocation;
...
- (void)mapView:(MKMapView *)mapView didFailToLocateUserWithError:(NSError *)error
{
    ...
    if ([error code] == kCLErrorDenied && [[error domain] isEqualToString:kCLErrorDomain]) {
        ...
        UIAlertController* alert = [UIAlertController alertControllerWithTitle:@"Could not locate you"
...
- (void)locationManager:(CLLocationManager *)manager
    ...
    if (abs(howRecent) < 15.0) {
        ...
        if (_waitingForLocation == YES) {
            ...
            [self addLocation:nil];
            MKCoordinateRegion reg = MKCoordinateRegionMakeWithDistance(self.currentLocation, 1500, 1500);
